"""
Django settings for onit_40720 project.
...
WSGI_APPLICATION = 'onit_40720.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "onit_40720 API",
    "DESCRIPTION": "API documentation for onit_40720 App",
    "VERSION": "v1",
}
